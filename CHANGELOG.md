...
### Changed
- Jumlah test: 192 → **244**; validator 16 aturan tetap exit 0 (aturan 7 & 13 diperluas untuk `arcs`/`safe_fallback_location`/`unlock_arc`; aturan 14 kini wajib minimal 1 lokasi `is_safe`; aturan 7 & 13 diperluas untuk upgrade teknik & efek `technique` — Tahap C C1).
- `README.md` & `PROJECT.md`: jumlah test disinkronkan (244).
